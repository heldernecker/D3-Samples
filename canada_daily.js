...
data.then(function (result) {
	...
	var svg = d3.select("svg"),
		margin = { top: 100, right: 200, bottom: 30, left: 50 },
	...
	const annotations = [
		{
			...
			y: 1,
			//Just setup the date in mm/dd/yyyy format and the annotation gets in the right place
			data: { x: "03/21/2020" }
		},
		{
			note: {
				label: "Peak for new cases"
			},
			subject: {
				y1: 0,
				y2: height
